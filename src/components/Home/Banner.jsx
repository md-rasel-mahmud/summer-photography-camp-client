        ...
        <SwiperSlide>
          <div className="flex flex-col-reverse lg:flex-row justify-around items-center min-h-[85vh]">
            ...
            <div className="w-full lg:w-1/3 text-center p-3 lg:text-left">
                ...
                <p>
                  Discover the wonders of summer through the lens of your
                  camera. Our Photography Camp offers a unique opportunity to
                  enhance your skills, explore breathtaking landscapes, and
